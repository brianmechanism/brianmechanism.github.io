            ...
            if [ -z "$name" ]; then
                ...
                if test -f "$dir/assets.txt"; then
                    ...
                    if test -f "$dir/$photoFile"; then
                        ...
                        sed -i "/^profilephoto:/ s|.*|profilephoto: assets/cv/cvPhotos/$cvName/$photoFile|" "$cvName.html"  ## edit link in html file
                    fi
                fi   
                ...
                mkdir -p ../../_pages/team/
                sed -i "2ipermalink: /team/\\$cvName" "$cvName.html"
                mv  "$cvName.html" ../../_pages/team/
            fi
        fi
    fi
done
