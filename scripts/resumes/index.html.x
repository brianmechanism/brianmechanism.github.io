...
<head>
    <meta charset="utf-8">
    <title>Brian Mechanisms Robotics</title>
    <meta name="description" content="'s Résumé">
    <meta name="author" content=" @">

    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <link rel="stylesheet" href="/assets/cv/css/base.css">
    <link rel="stylesheet" href="/assets/cv/css/skeleton.css">
    <link rel="stylesheet" href="/assets/cv/css/layout.css">
    ...
    <link rel="shortcut icon" href="/assets/cv/img/favicon.ico">
...
<div class="container">
    <header class="three columns">
        <img src="/static/img/profile.png" class="me">
        <h1>Team Member</h1>
        <article>
            <header>
                <h1>CONTACT</h1>
